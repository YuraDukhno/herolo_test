...
export default function HomePage({
  ...
  const addFavorites = (location, currWeather) => {
    ...
    console.log("🚀 ~ file: HomePage.jsx ~ line 48 ~ id", id)
      // debugger
            ...
            <div>
              ...
              {favorites.some(favorite => favorite.id === currCity.id) ? (
                <div
                  className="btn"
                  type="submit"
                  onClick={() => removeFavorites(currCity.id)}
                >
                ...
                <div
                  className="btn"
                  type="submit"
                  onClick={() => addFavorites(currCity,todaysForecast.Temperature.Maximum.Value)}>
                  Add to favorites
                </div>
              )}
            </div>
